...
class AdapterFootballClubs(
    private var callTeamComposition: (name: String) -> Unit
) :
    RecyclerView.Adapter<AdapterFootballClubs.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.item_view_football_clubs, parent, false
            )
        )
    }
    ...
    inner class MyViewHolder(
        ...
        private var goOver: TextView =
            itemView.findViewById(R.id.item_view_football_clubs_go_over_txt)
        private var name: TextView = itemView.findViewById(R.id.item_view_football_clubs_name_txt)
        private var city: TextView = itemView.findViewById(R.id.item_view_football_clubs_city_txt)
        private var logo: ImageView =
            itemView.findViewById(R.id.item_view_football_clubs_photo_players_img)
